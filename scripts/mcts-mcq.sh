...
ACTOR_MODEL_NAME_OR_PATH="/home/users/nus/e0672129/scratch/MCTS-DPO/outputs/sqa/mistral-d2-8x1/steps1536"
...
OUTPUT_DIR="/home/users/nus/e0672129/scratch/MCTS-DPO/outputs/sqa/mistral-d2-8x1"
unset HOSTFILE
ZERO_STAGE=3
OFFLOAD="optimizer"
while [[ "$#" -gt 0 ]]; do
