...
ACTOR_MODEL_NAME_OR_PATH="/home/users/nus/e0672129/scratch/MCTS-DPO/outputs/checkpoints/arithmetic/llama3-cdpo-fullsft/steps1024"
...
bash scripts/examples/mcts_mathqa_llama3.sh $1