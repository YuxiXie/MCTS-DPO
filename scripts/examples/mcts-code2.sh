...
ACTOR_MODEL_NAME_OR_PATH="/home/users/nus/e0672129/scratch/MCTS-DPO/outputs/experiments/code/mistral-offline-mcts/steps512"
...
OUTPUT_DIR="/home/users/nus/e0672129/scratch/MCTS-DPO/outputs/experiments/code/mistral-offline-mcts"
unset HOSTFILE
ZERO_STAGE=3
OFFLOAD="optimizer"
...
deepspeed --include localhost:$gpu_vis --master_port $MASTER_PORT \
	...
	--train_datasets MathQACode/train \
