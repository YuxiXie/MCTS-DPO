...
from mcts_rl.configs import get_deepspeed_eval_config
from mcts_rl.datasets import SafetyPreferenceDataset, parse_dataset
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        prog='deepspeed --module mcts_rl.evaluate.cost',
